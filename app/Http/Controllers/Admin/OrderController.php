...
class OrderController extends Controller
{
    ...
    //    return $request ;
        ...
        $order->thana=$request->sub_city;
        $order->courier_id=$request->courier;
        $order->shipping_cost=$request->shipping_cost ?? 0;
        $order->additional_charge=$request->additional_charge ?? 0;
