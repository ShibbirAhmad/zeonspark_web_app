...
const routes = [
    ...
    {
        path: '/fast-delivery',
        component: () => import(/* webpackChunkName: "fast_delivery" */'./components/public/policy_and_info/fast_delivery.vue'),
        name: 'fast_delivery',
        meta: {
            title: 'Fast Delivery '
        }
    ...
    {
        path: '/best-prices',
        component: () => import(/* webpackChunkName: "best_prices" */'./components/public/policy_and_info/best_prices.vue'),
        name: 'best_prices',
        meta: {
            title: 'Best Prices '
        }
    ...
    {
        path: '/stiching/service',
        component: () => import(/* webpackChunkName: "stiching_service" */'./components/public/policy_and_info/stiching_service.vue'),
        name: 'stiching_service',
        meta: {
            title: 'stiching service '
        }
    },
    ...
    {
        path: '/payments/info',
        component: () => import(/* webpackChunkName: "secure_payments" */'./components/public/policy_and_info/secure_payment.vue'),
...

    {
        ...
        component: () => import(/* webpackChunkName: "partner_request" */'./components/public/PartnerRequest.vue'),
    ...
    {
        path: '/backend/requested/partners',
        component: () => import(/* webpackChunkName: "partner_requested" */'./components/admin/merchant/partner_request.vue'),
        name: 'partner_requested',
        meta: {
    ...
    {
        path: '/backend/offer/banner',
        component: () => import(/* webpackChunkName: "offer_banner" */'./components/admin/offer/Index.vue'),
        name: 'offer_banner',
        meta: {
            requiresAuthAdmin: true,
            title: 'offer banner'
    ...
    {
        path: '/backend/offer/banner/add',
        component: () => import(/* webpackChunkName: "add_offer_banner" */'./components/admin/offer/Add'),
        name: 'add_offer_banner',
        meta: {
            requiresAuthAdmin: true,
            title: 'add offer banner'
        }
    },
    {
        path: '/backend/edit/banner/offer/:id',
        component: () => import(/* webpackChunkName: "edit_offer_banner" */'./components/admin/offer/Edit'),
...

    {
...

     {
      ...
      {
        path: '/backend/service/information',
        name: 'service_information',
        component: () => import(/* webpackChunkName: "service_information"*/'./components/admin/page_info/ServiceInformation.vue'),
        meta: {
            requiresAuthAdmin: true,
...

{
    ...
    },
    {
     ...
     {
        path: '/backend/beside/slider/banner',
        name: 'beside_slider_banner',
        component: () => import(/* webpackChunkName: "beside_slider_banner" */'./components/admin/banner/BesideSliverBanner.vue'),
        meta: {
            requiresAuthAdmin: true,
            title:'Beside Slider Banner',
        }
    },
     ...
     {
        path: '/backend/under/new/arrival/banner',
        name: 'under_new_arrival_banner',
        component: () => import(/* webpackChunkName: "under_new_arrival_banner" */'./components/admin/banner/UnderNewArrival.vue'),
        meta: {
            requiresAuthAdmin: true,
            title:'under new arrival Banner',
        }
    },
