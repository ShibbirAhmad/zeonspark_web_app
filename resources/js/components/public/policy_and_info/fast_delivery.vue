            ...
            <div class="col-sm-12 col-md-12">
              <div style="background-color:#eee" class="container-fluid ">
                <div style="margin-top:20px;" class="container">
                  ...
                  <h4 style="padding:15px" class="heading" > <i class="fa fa-eye"></i><b> Fast Delivery</b>   </h4>

                  <p v-html="fast_delivery" style="padding-bottom:20px;">  </p>
     ...
     getSericeInfo(){
         ...
         .then(resp=>{
           ...
           if (resp.data.status=="OK") {
             this.fast_delivery=resp.data.service.fast_delivery ;
