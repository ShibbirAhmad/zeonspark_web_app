            ...
            <div class="col-sm-12 col-md-12">
              <div style="background-color:#eee" class="container-fluid ">
                <div style="margin-top:20px;" class="container">
                  ...
                  <h4 style="padding:15px" class="heading" > <i class="fa fa-eye"></i><b> Stiching Details </b>   </h4>

                  <p v-html="stiching" style="padding-bottom:20px;">  </p>
     ...
     getSericeInfo(){
         ...
         .then(resp=>{
           ...
           if (resp.data.status=="OK") {
             this.stiching=resp.data.service.stiching ;
