  ...
  <div>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="row">
          <div class="col-lg-11" v-show="editContent==1">
                    ...
                    <div class="box box-primary">
                      ...
                      <div class="box-body">
                        <ckeditor
                          :editor="editor"
                          name="specification"
                          :class="{ 'is-invalid': form.errors.has('specification') }"
                          v-model="form.specification"
                          :config="editorConfig"
                        ></ckeditor>
                        <has-error :form="form" field="specification"></has-error>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="box box-primary">
                      ...
                      <div class="box-body">
                        <ckeditor
                          :editor="editor"
                          name="size_chart"
                          :class="{ 'is-invalid': form.errors.has('size_chart') }"
                          v-model="form.size_chart"
                          :config="editorConfig"
                        ></ckeditor>
                        <has-error :form="form" field="size_chart"></has-error>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="box box-primary">
                      ...
                      <div class="box-body">
                        <ckeditor
                          ...
                          :class="{ 'is-invalid': form.errors.has('delivery_policy') }"
                          v-model="form.delivery_policy"
                          :config="editorConfig"
                        ></ckeditor>
                        <has-error :form="form" field="delivery_policy"></has-error>
                      </div>
                    </div>
                  </div>
      ...
      axios
        ...
        .then((resp) => {
          ...
          if (resp.data.status == "SUCCESS") {
            ...
            this.form.size_chart = resp.data.product.size_chart  ?  resp.data.product.size_chart  : '' ;
            this.form.delivery_policy = resp.data.product.delivery_policy ? resp.data.product.delivery_policy : '' ;
            this.form.merchant_id=resp.data.product.merchant_id;
            this.form.stock=resp.data.product.stock;
