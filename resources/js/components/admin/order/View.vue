                  ...
                  <div class="row print_info_container">
                    ...
                    <div class="col-md-3 col-sm-3 description">
                      <div>
                        ...
                        <p>
                          District: <strong> {{ order.city }} </strong>
                        </p>
                        <p>
                          Thana:
                          <strong>
                            {{ order.thana ? order.thana : "none" }}
                          </strong>
                        </p>
                    ...
                    <div class="col-md-3 col-sm-3">
                      <div v-if="order.billing_address_is == 'other'">
                        <h4>Shipping Info</h4>
                        <p>Receiver Name: {{ order.shipping_name }}</p>
                        <p>
                          Receiver Mobile No:
                        ...
                        <p class="address_line">
                          Receiver Address: {{ order.shipping_address }}
                        </p>
                      </div>
                      <div v-else>
                        <h4>Shipping Address is Same</h4>
                      </div>
                    </div>
                    <div
                    ...
                    >
                      ...
                      />
                      <p
                        v-html="general_setting.invoice_address_details"
                        class="address_line"
                      ></p>
                      <p>
                          ...
                          <tr>
                            ...
                            <td>
                              <b>{{
                                ...
                                parseInt(order.additional_charge)) - parseInt(order.discount)
                              }}</b>
                            </td>
                          </tr>
                        </tbody>
...
export default {
  ...
  methods: {
    ...
    updateResellerCommision() {
      let commission = document.getElementById(
        "reseller_order_commision"
      ).value;
