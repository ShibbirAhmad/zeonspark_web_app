<template>
  <div>
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-2">
                      <select v-model="bulkActionType" class="form-control">
                        ...
                        <option value="EXPORT SELECTED ITEM">
                  ...
                  <table class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td>
                          <button class="btn" @click="comment(order.id)">
                            Comment
                          </button>
                          <span
                            style="font-size: 12px"
                            v-if="order.order_note.length > 0"
                          >
    ...
    <modal name="example" :width="300" :height="250">
      <div class="card">
...
export default {
  ...
  methods: {
    ...
    commentBackup(order_id, order_index, comment) {
      console.log(comment);
      let options = {};
