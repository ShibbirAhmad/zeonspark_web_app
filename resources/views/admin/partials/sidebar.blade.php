        ...
        @endif
          @if($admin->can('create and manage slider'))
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li>
                        <router-link :to="{ name: 'slider'}"><i class="fa fa-eye"></i>Landing Slider</router-link>
                    </li>
                    <li>
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-sliders"></i> <span>Advertise Banner</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                     ...
                     <li>
                        <router-link :to="{ name: 'beside_slider_banner'}"><i class="fa fa-eye"></i> Beside Slider</router-link>
                    </li>

                    <li>
                        <router-link :to="{ name: 'under_new_arrival_banner'}"><i class="fa fa-eye"></i>Under New Arrival</router-link>
                    </li>
                    <li>
                           <router-link :to="{ name: 'offer_banner'}"><i class="fa fa-eye"></i>Banner Under Slider</router-link>
                    </li>
                </ul>
            </li>
            ...
            <li class="treeview">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li>
                            <router-link :to="{ name: 'service_information'}"><i class="fa fa-list-alt"></i> Service Information </router-link>
                        </li>
