...
Route::group([
    ...
    Route::get('api/get/info/service','HomeController@getServiceInfo');
    ...
    Route::get('related/products/{slug}', 'HomeController@relatedProduct');
    ...
    Route::post('api/partner/request','ContactController@partnerRequest');
   ...
   //slider display route started here
    ...
    Route::get('api/display/category/slider/{slug}', 'HomeController@display_category_slider');
    Route::get('api/display/sub/category/slider/{slug}', 'HomeController@display_sub_category_slider');
    Route::get('api/display/sub/sub/category/slider/{slug}', 'HomeController@display_sub_sub_category_slider');
   // slider route end
  ...
  //chekout route
    Route::get('apply/coupon/code', 'HomeController@ApplyCoupon');
    Route::get('apply/coupon/code', 'HomeController@ApplyCoupon');
    Route::post('image/upload/by/editor', 'HomeController@ckEditorImageUpload');
...
Route::group([
  ...
  // end carrier controller here
    ...
    Route::post('api/banner/offer/add', 'SaleCampaignController@addOfferBanner');
    Route::get('api/banner/offer/item/{id}', 'SaleCampaignController@getOfferBanner');
    Route::post('api/banner/offer/edit/{id}', 'SaleCampaignController@updateOfferBanner');
    Route::get('api/banner/offers', 'SaleCampaignController@offerBanners');
    Route::get('api/banner/offer/active/{id}', 'SaleCampaignController@activeOfferBanner');
    Route::get('api/banner/offer/deActive/{id}', 'SaleCampaignController@deActiveOfferBanner');
    Route::get('api/banner/offer/delete/{id}', 'SaleCampaignController@destroyOfferBanner');
 ...
 Route::get('api/fond/transfer','FondTransferController@index');
  ...
  //service info
  Route::get('api/get/service/information','PageInfoController@servieInfo');
  Route::post('api/edit/service/info/{id}','PageInfoController@updateServiceInfo');
  ...
  Route::post('api/edit/buy/one/get/one/offer/{id}','SaleCampaignController@edit_buy_one_get_one_campaign');
    ...
    Route::get('api/partner/request/list','CompanyController@partnerRequestList');
