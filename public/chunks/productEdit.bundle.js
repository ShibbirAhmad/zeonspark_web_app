    ...
    edit: function edit() {
      ...
      axios.get("/edit/product/" + this.$route.params.id).then(function (resp) {
        ...
        if (resp.data.status == "SUCCESS") {
          ...
          _this.form.size_chart = resp.data.product.size_chart ? resp.data.product.size_chart : '';
          _this.form.delivery_policy = resp.data.product.delivery_policy ? resp.data.product.delivery_policy : '';
          _this.form.merchant_id = resp.data.product.merchant_id;
          _this.form.stock = resp.data.product.stock;
                              ...
                              _c(
                                ...
                                [
                                  _c("ckeditor", {
                                    ...
                                    model: {
                                      value: _vm.form.size_chart,
                                      callback: function($$v) {
                                        _vm.$set(_vm.form, "size_chart", $$v)
                                      },
                                      expression: "form.size_chart"
                                    }
                                  }),
                                  _vm._v(" "),
                                  _c("has-error", {
                              ...
                              _c(
                                ...
                                [
                                  _c("ckeditor", {
                                    ...
                                    model: {
                                      value: _vm.form.delivery_policy,
                                      callback: function($$v) {
                                        _vm.$set(
                                          _vm.form,
                                          "delivery_policy",
                                      ...
                                      expression: "form.delivery_policy"
                                    }
                                  }),
                                  _vm._v(" "),
                                  _c("has-error", {
