    ...
    getGeneralSetting: function getGeneralSetting() {
      ...
      axios.get('/api/get/site/info').then(function (resp) {
        ...
        if (resp.data.status == "OK") {
          ...
          _this.form.contact_two = resp.data.setting.contact_two ? resp.data.setting.contact_two : "";
          _this.form.contact_three = resp.data.setting.contact_three ? resp.data.setting.contact_three : "";
          ...
          _this.form.facebook_pixel_code = resp.data.setting.facebook_pixel_code ? resp.data.setting.facebook_pixel_code : "";
                    ...
                    [
                      _c("div", { staticClass: "row" }, [
                        _c("div", { staticClass: "col-lg-12" }, [
                              ...
                              _c(
                                ...
                                [
                                  ...
                                  _c("input", {
                                    directives: [
                                      {
                                        name: "model",
                                        rawName: "v-model",
                                        value: _vm.form.contact_two,
                                        expression: "form.contact_two"
                                      }
                                    ],
                                    staticClass: "form-control",
                                    class: {
                                    ...
                                    attrs: { type: "number" },
                                    domProps: { value: _vm.form.contact_two },
                                    on: {
                                      input: function($event) {
                                        if ($event.target.composing) {
                                          return
                              ...
                              _c(
                                ...
                                [
                                  ...
                                  _c("input", {
                                    directives: [
                                      {
                                        name: "model",
                                        rawName: "v-model",
                                        value: _vm.form.contact_three,
                                        expression: "form.contact_three"
                                      }
                                    ],
                                    staticClass: "form-control",
                                    class: {
                                    ...
                                    attrs: { type: "text" },
                                    domProps: { value: _vm.form.contact_three },
                                    on: {
                                      input: function($event) {
                                        if ($event.target.composing) {
                                          return
                          ...
                          _vm._v(" "),
                          _c("div", { staticClass: "form-group" }, [
                            _c("label", [_vm._v(" Facebook Chat Plugin ")]),
                            _vm._v(" "),
                            _c("textarea", {
                              directives: [
                                {
                          ...
                          _c("div", { staticClass: "form-group" }, [
                            _c("label", [
                              _vm._v(" Facebook Domain Verification ")
                            ]),
                            _vm._v(" "),
                            _c("textarea", {
                              directives: [
                              ...
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model",
                                  value: _vm.form.facebook_pixel_code,
                                  expression: "form.facebook_pixel_code"
                                }
                              ],
                              staticClass: "form-control",
                              attrs: { rows: "5" },
                              domProps: { value: _vm.form.facebook_pixel_code },
                              on: {
                                input: function($event) {
                                  if ($event.target.composing) {
                                    return
                          ...
                          _c("div", { staticClass: "form-group" }, [
                            _c("label", [
                              _vm._v(" Google Domain Verification ")
                            ]),
                            _vm._v(" "),
                            _c("textarea", {
                              directives: [
                          ...
                          _vm._v(" "),
                          _c("div", { staticClass: "form-group" }, [
                            _c("label", [_vm._v(" Google Analytics ")]),
                            _vm._v(" "),
                            _c("textarea", {
                              directives: [
                                {
