...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
      ...
      if (length >= 4) {
        axios.get("/search/single/product/" + this.search).then(function (resp) {
          ...
          if (resp.data.product) {
            var product = resp.data.product; // if(product.stock>0){
            ...
            _this3.validationPreview = false; // }else{
    ...
    validation: function validation() {
      ...
      if ( // this.preview_products.price.length > 0 &&
      this.preview_products.quantity.length > 0 && this.preview_products.product_id && this.search.length > 0 && parseInt(this.preview_products.quantity) <= parseInt(this.preview_products.stock)) {
