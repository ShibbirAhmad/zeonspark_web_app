...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    addToCart: function addToCart(slug) {
      var _this2 = this;
    ...
    subSubCategoryWiseProduct: function subSubCategoryWiseProduct($state) {
      ...
      axios.get("/_public/sub/sub/category/wise/product/?page=" + this.page, {
        ...
        if (resp.data.data.length) {
          ...
          (_this4$products = _this4.products).push.apply(_this4$products, _toConsumableArray(resp.data.data));
    ...
    price_sorting_asec_desc: function price_sorting_asec_desc() {
      ...
      axios.get("/_public/api/sort/product/sub/sub/category/according/to/asc/desc", {
        ...
        (_this5$products = _this5.products).push.apply(_this5$products, _toConsumableArray(resp.data.products));
      });
    },
    getSubSubCatgory: function getSubSubCatgory() {
      ...
      axios.get("/_public/sub/sub/category/" + this.$route.params.slug).then(function (resp) {
        //console.log(resp);
        _this6.sub_sub_categories = resp.data.sub_sub_categories;
      });
    },
                  ...
                  _vm._l(_vm.products, function(product) {
                    return _c(
                      "div",
                      {
                        key: product.id,
                        staticClass:
                          "col-lg-4 custom_padding col-sm-4 col-md-4 col-xs-6  "
                      },
                      [
                        _c("div", { staticClass: "product-card " }, [
                          ...
                          _c("div", { staticClass: "product-card-footer" }, [
                            _c(
                              "div",
                              { staticClass: "new_arrival_card_footer" },
                              [
                                      ...
                                      "a",
                                      {
                                        on: {
                                          click: function($event) {
                                            return _vm.addToCart(product.slug)
                                          }
                                        }
                                      },
                                      [_vm._v("Add To Cart")]
